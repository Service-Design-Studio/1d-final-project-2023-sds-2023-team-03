...
RSpec.describe Api::V1::CompetitorsController, type: :controller do
  ...
  describe "GET #index" do
    let(:competitor_sale1) { create(:competitor, competitor_name: 'Under Armour', product_id: 1, sales: 100) }
    let(:competitor_sale2) { create(:competitor, competitor_name: 'Under Armour', product_id: 2, sales: 200) }
    let(:competitor_sale3) { create(:competitor, competitor_name: 'Under Armour', product_id: 3, sales: 156) }
    let(:competitor_sale4) { create(:competitor, competitor_name: 'Under Armour', product_id: 4, sales: 77) }
    let(:competitor_sale5) { create(:competitor, competitor_name: 'Under Armour', product_id: 5, sales: 90) }
    let(:competitor_sale6) { create(:competitor, competitor_name: 'Under Armour', product_id: 6, sales: 299) }
...
#         expect do
#           delete :destroy, params: {product_id: new_comp.product_id}
...
#       get :show, params:  { product_id: comp.product_id }
...
#         put :update, params: { product_id: competitorsale.id, competitor: valid_params1 }
...
#         put :update, params: { product_id: competitorsale.id, competitor: invalid_params }
#         expect(response.content_type).to eq('application/json; charset=utf-8')
#       end
#     end
#   end
